...
public class Ex12 {
    ...
    public static void main(String[] args) {
        double principal = Ex12.readNumber("Enter the principal:");
        double inRate = Ex12.readNumber("Enter the rate of interest:");
        double years = Ex12.readNumber("Enter the number of years:");

        double investment = (((inRate/100) * years) + 1) * principal;

        System.out.printf("After %.0f years at %.1f, the investment will be worth $%.2f", years, inRate, investment);
    }
